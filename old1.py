#opensource_by_tymor
#thanks_tymor_github
#my_github_https://github.com/Tymor
#wp:0343
...
\033[1;90m════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : Tymor Tricks
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : Nahi Hai
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : Tymor
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[QAISER] : %s/%s -> \033[0;97m [Tymor-OK:%s ] \033[0;97m[Tymor-CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
